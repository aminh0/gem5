...
for.cond.cleanup:                                 ; preds = %fibo.exit
  %puts = tail call i32 @puts(ptr nonnull dereferenceable(1) @str)
  ret i32 0

for.body:                                         ; preds = %entry, %fibo.exit
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %fibo.exit ]
  tail call void asm sideeffect "nop", "~{memory}"() #3, !srcloc !9
  %cmp4.i.not = icmp eq i64 %indvars.iv, 0
  br i1 %cmp4.i.not, label %fibo.exit, label %for.body.i
...
for.body.i:                                       ; preds = %for.body, %for.body.i
  ...
  br i1 %exitcond.not.i, label %fibo.exit, label %for.body.i, !llvm.loop !6

fibo.exit:                                        ; preds = %for.body.i, %for.body
  ...
  tail call void asm sideeffect "nop", "~{memory}"() #3, !srcloc !14
