...
@array = dso_local global [4 x [1000000 x i64]] zeroinitializer, align 8
...
for.body:                                         ; preds = %entry, %dest
  %indvars.iv39 = phi i64 [ 0, %entry ], [ %indvars.iv.next40, %dest ]
  tail call void asm sideeffect "nop", "~{memory}"() #2, !srcloc !6
  br label %for.body3

for.body3:                                        ; preds = %for.body, %for.body3
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.body3 ]
  %0 = or disjoint i64 %indvars.iv, %indvars.iv39
  %arrayidx7 = getelementptr inbounds nuw [4 x [1000000 x i64]], ptr @array, i64 0, i64 %indvars.iv, i64 %indvars.iv39
  store volatile i64 %0, ptr %arrayidx7, align 8, !tbaa !7
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 4
  br i1 %exitcond.not, label %dest, label %for.body3, !llvm.loop !11

dest:                                             ; preds = %for.body3
  %1 = add nuw nsw i64 %indvars.iv39, 10
  %arrayidx14 = getelementptr inbounds nuw [1000000 x i64], ptr getelementptr inbounds nuw (i8, ptr @array, i64 8000000), i64 0, i64 %1
  %2 = load volatile i64, ptr %arrayidx14, align 8, !tbaa !7
  %rem15 = srem i64 %2, 10
  %3 = add nuw nsw i64 %indvars.iv39, 9
  %arrayidx21 = getelementptr inbounds nuw [1000000 x i64], ptr @array, i64 0, i64 %3
  store volatile i64 %rem15, ptr %arrayidx21, align 8, !tbaa !7
  tail call void asm sideeffect "nop", "~{memory}"() #2, !srcloc !14
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 8
  %cmp = icmp samesign ult i64 %indvars.iv39, 999992
  br i1 %cmp, label %for.body, label %for.end24, !llvm.loop !15

for.end24:                                        ; preds = %dest
  %call = tail call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
  ret i32 0
}
